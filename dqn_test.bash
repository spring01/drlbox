...
# cartpole dqn
hcdrl_dqn.py --rl_train_steps 500 --rl_save_path $output \
...
hcdrl_evaluator.py --net_type qnet --read_weights $cartpole_weights \
    --policy_eps 0.05 --render false --eval_episodes 3 || clean_exit 1

# breakout dqn fc
hcdrl_dqn.py --env Breakout-v0 --env_num_frames 4 --env_act_steps 4 \
...
hcdrl_evaluator.py --env Breakout-v0 --env_num_frames 4 --env_act_steps 4 \
