...
python dqn_trainer.py --env Breakout-v0 --env_num_frames 4 --env_act_steps 4 \
    ...
    --additional model.atari_nets 'fc' 256 || clean_exit 1
...
python dqn_trainer.py --env Breakout-v0 --env_num_frames 4 --env_act_steps 4 \
    ...
    --interval_sync_target 200 --interval_save 200 \
    --memory_maxlen 200 --memory_fill 100 \
    --additional model.atari_nets 'dueling fc' 256 || clean_exit 1
...
python dqn_trainer.py --env Breakout-v0 --env_num_frames 4 --env_act_steps 4 \
    ...
    --interval_sync_target 200 --interval_save 200 \
    --memory_maxlen 200 --memory_fill 100 \
    --additional model.atari_nets 'dueling gru' 64 || clean_exit 1
